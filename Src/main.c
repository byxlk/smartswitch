...
void main(void)
{
	...
	while (1)
	{
        ...
        if(VoltCurrentStatus != NORMAL_VOLTAGE)
        {
            ...
            if(VoltExceptionsPlus == 0xFF) VoltExceptionsPlus = 0;     //Êä³öµçÑ¹Òì³£µÄÂö³åÐÅºÅ
            ...
            {
                // 2¡¢¼ì²âµ½ºÏÕ¢µ½Î»ÐÅºÅ£¬
                //    ×Ô¶¯£ºµç»ú£¨Õý×ª£©µ½£¨ÍÑ¿Ûµ½Î»£©×´Ì¬¾Í£¨Í£Ö¹ÔË×ª£©
                //    ÊÖ¶¯£ºµç»ú£¨Õý×ª£©µ½£¨ÍÑ¿Ûµ½Î»£©×´Ì¬¾Í£¨Í£Ö¹ÔË×ª£©
